  ...
  <div class="card-footer p-1 text-center">
    <div class="float-start">
      ...
      @if($pirep->comments->count() > 0)
        <span class="badge badge-phoenix badge-phoenix-info">Check Comments</span>
      @endif
    </div>
    @if(!empty($pirep->simbrief))
      <div class="float-end">
        <a class="badge badge-phoenix badge-phoenix-secondary" href="{{ route('frontend.simbrief.briefing', $pirep->simbrief->id) }}" target="_blank">
          SimBrief Briefing
        </a>
        <span type="button" class="badge badge-phoenix badge-phoenix-primary" data-bs-toggle="modal" data-bs-target="#OFP_Modal">
          SimBrief OFP
        </span>
      </div>
    @endif
